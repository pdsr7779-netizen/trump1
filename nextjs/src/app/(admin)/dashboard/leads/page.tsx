...
export default function LeadsPage() {
  ...
  const exportCsv = () => {
    ...
    a.download = `접수내역_${new Date().toISOString().split("T")[0]}.csv`;
    a.click();
  };
            ...
            <div className="modal-body">
              <div className="detail-grid">
                <div className="detail-item">
                  ...
                  <span>
                    {detail.dateRaw
                      ? new Date(detail.dateRaw).toLocaleString("ko-KR", {
                          timeZone: "Asia/Seoul",
                        })
                      : detail.date}
                  </span>
                ...
                <div className="detail-item">
                  ...
                  <span>
                    {detail.amount}
                    {detail.fundType !== "-" ? ` (${detail.fundType})` : ""}
                  </span>
                </div>
                <div className="detail-item">
                  <label>통화가능시간</label>
                  <span>{detail.callTime || "-"}</span>
                </div>
