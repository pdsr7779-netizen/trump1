const SITE_URL = "https://trump1.co.kr";
const SITE_NAME = "트럼프 파트너스";
const PHONE = "1844-1053";
const ADDRESS = "경기도 김포시 김포한강10로 133번길 80 210호";
const BIZ_NO = "497-24-01418";
const CEO_NAME = "이소영";
...
export function organizationSchema() {
  return {
    ...
    description:
      "중소기업·소상공인 정부정책자금 전문 경영컨설팅. 기업심사관이 현황분석부터 자금확보까지 밀착 지원합니다. 심사승인율 96%.",
    slogan: "성공을 확정할 단 하나 승리카드",
    foundingDate: "2024",
    taxID: BIZ_NO,
    founder: {
      "@type": "Person",
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "김포한강10로 133번길 80 210호",
      addressLocality: "김포시",
      addressRegion: "경기도",
      addressCountry: "KR",
    },
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        ...
        {
          "@type": "Offer",
          itemOffered: { "@type": "Service", name: "온라인마케팅 솔루션" },
        },
      ],
    },
    sameAs: [SITE_URL],
...
export function localBusinessSchema() {
  return {
    ...
    telephone: PHONE,
    description:
      "트럼프 파트너스는 정책자금 전문 경영컨설팅 기업입니다. 대표자 역량 분석부터 맞춤형 자금 전략 수립까지 체계적 지원을 제공합니다.",
    priceRange: "무료 상담",
    address: {
      "@type": "PostalAddress",
      streetAddress: "김포한강10로 133번길 80 210호",
    ...
    makesOffer: [
      {
        "@type": "Offer",
        itemOffered: { "@type": "Service", name: "무료 정책자금 상담" },
        price: "0",
        priceCurrency: "KRW",
      },
    ],
...
export function faqSchema() {
  const faqs = [
    ...
    },
    {
      ...
      a: "사업 유형별로 차이가 있으나 긴급운전자금은 3-4주 내, 일반 정책자금은 2-3개월 수준입니다. 트럼프 파트너스는 최대 지원금액, 유리한 금리조건, 장기 상환조건 확보에 집중합니다.",
    },
    {
      q: "자금 수령 이후에도 지속적인 관리를 받을 수 있나요?",
      a: "트럼프 파트너스는 장기적 성장 파트너를 지향합니다. 자금 활용 모니터링, 후속 지원사업 추천, 추가 자금 조달 지원 등을 종합 제공합니다. 단발성 지원이 아닌 지속가능한 성장 기반을 함께 구축해나가겠습니다.",
    },
  ];
...
export function webSiteSchema() {
  return {
    ...
    "@id": `${SITE_URL}/#website`,
    name: SITE_NAME,
    alternateName: "트럼프 파트너스 정부정책자금 경영컨설팅",
    url: SITE_URL,
    inLanguage: "ko",
    description:
      "중소기업·소상공인 정부정책자금 자금확보 전문 경영컨설팅. 기업심사관이 현황분석부터 심사승인까지 밀착 지원.",
    publisher: {
      "@id": `${SITE_URL}/#organization`,
    },
    potentialAction: {
      ...
      target: {
        "@type": "EntryPoint",
        urlTemplate: `${SITE_URL}/fund`,
      },
      "query-input": "required name=search_term_string",
    },
    speakable: {
      "@type": "SpeakableSpecification",
      cssSelector: ["h1", "h2", ".hero-message", ".hero-title"],
    },
  };
}

/** CEO 대표자 구조화 데이터 - AEO: "트럼프 파트너스 대표 누구?" 질문 대응 */
export function personSchema() {
  return {
    ...
    description: `${SITE_NAME} 대표 ${CEO_NAME}. 정부정책자금 경영컨설팅 기업심사관으로 중소기업·소상공인 자금확보를 전문 지원합니다.`,
    knowsAbout: [
      "정부정책자금",
      "경영컨설팅",
      "자금조달 전략",
    ...
    image: `${SITE_URL}/images/ceo-profile.jpg`,
  };
}
...
export function howToSchema() {
  return {
    ...
    description:
      "트럼프 파트너스의 정책자금 성장 지원 6단계 프로세스. 무료 상담 접수부터 사후 관리까지 체계적으로 진행됩니다.",
    totalTime: "P90D",
    step: [
      {
        "@type": "HowToStep",
        position: 1,
        name: "무료 상담 접수",
        text: "전화(1844-1053) 또는 온라인으로 무료 상담을 접수합니다. 기업 현황과 필요 자금 규모를 간단히 알려주시면 됩니다.",
      },
      {
        "@type": "HowToStep",
        position: 2,
